...
pub(crate) fn load_forms(_: RwSignal<Vec<DatasetFormOption>>, _: RwSignal<Option<String>>) {}

#[cfg(feature = "hydrate")]
pub(crate) fn load_nodes(nodes: RwSignal<Vec<NodeResponse>>, load_error: RwSignal<Option<String>>) {
    leptos::task::spawn_local(async move {
...
#[cfg(not(feature = "hydrate"))]
pub(crate) fn load_nodes(_: RwSignal<Vec<NodeResponse>>, _: RwSignal<Option<String>>) {}
...
#[cfg(not(feature = "hydrate"))]
pub(crate) fn load_users(_: RwSignal<Vec<DatasetUserOption>>, _: RwSignal<Option<String>>) {}

#[cfg(feature = "hydrate")]
pub(crate) fn load_rendered_form(
...
#[cfg(not(feature = "hydrate"))]
pub(crate) fn load_rendered_form(_: String, _: RwSignal<BTreeMap<String, DatasetRenderedForm>>) {}
