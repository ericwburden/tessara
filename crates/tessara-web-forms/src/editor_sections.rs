...
pub(crate) fn FormIdentityFields(
...
pub(crate) fn FormInitialVersionSummary(builder_field_count: Memo<usize>) -> impl IntoView {
    view! {
...
pub(crate) fn FormEditableVersionSummary(
