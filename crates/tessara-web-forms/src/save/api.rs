...
use crate::types::{CreateFormPayload, UpdateFormPayload};
...
pub(super) async fn create_form(
    ...
    tessara_web_http::send_json(
        gloo_net::http::Request::post("/api/admin/forms"),
        &payload,
        "Create form",
    )
    .await
    .map_err(FormSaveApiError::from_request)
}
