        ...
        try {
          ...
          showCards(payload, (dataset) => `
            <article class="card">
              ...
              <p class="muted">${escapeHtml(dataset.slug)} Â· ${escapeHtml(dataset.grain)} grain Â· ${escapeHtml(dataset.composition_mode)} composition</p>
      ...
      async function loadDatasetByValue(datasetId) {
        ...
        setDetail(`
          <article class="card">
            ...
            <p>${escapeHtml(payload.name)}</p>
            <p class="muted">${escapeHtml(payload.slug)} Â· ${escapeHtml(payload.grain)} grain Â· ${escapeHtml(payload.composition_mode)} composition</p>
        ...
        setDetail(`
          ...
          ${payload.rows.map((row) => `
            <article class="card">
              ...
              <p class="muted">${escapeHtml(row.source_alias)} source Â· ${escapeHtml(row.submission_id)}</p>
              <div class="table-wrap">
                <table>
                  <thead>
