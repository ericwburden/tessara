...
const HIERARCHY_ACTIONS: &[Action] = &[
    ...
    Action::new("loadNodes()", "Choose Node To Edit"),
];
...
const REPORTING_INPUTS: &[TextInput] = &[
    ...
    TextInput::new(
        "aggregation-group-by-logical-key",
        "Aggregation group-by logical key",
        "Optional group logical key",
        "",
    ),
    TextInput::new(
    ...
    TextInput::new(
        "aggregation-source-logical-key",
        "Aggregation source logical key",
        "participants",
        "participants",
    ),
...
const REPORTING_ACTIONS: &[Action] = &[
    ...
    Action::new("createAggregation()", "Create Aggregation"),
    Action::new("loadAggregations()", "Load Aggregations"),
    Action::new("loadAggregationDefinitionById()", "Inspect Aggregation"),
    Action::new("updateAggregation()", "Update Aggregation"),
    Action::new("deleteAggregation()", "Remove Aggregation"),
    Action::new("loadAggregationById()", "Run Aggregation"),
