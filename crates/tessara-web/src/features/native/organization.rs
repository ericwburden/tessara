...
pub(super) fn pagination_page_count(total_count: usize, page_size: usize) -> usize {
    if total_count == 0 {
        1
    } else {
...
pub(super) fn pagination_current_page(total_count: usize, page_size: usize, page_index: usize) -> usize {
    page_index.min(pagination_page_count(total_count, page_size) - 1)
}

pub(super) fn pagination_page_start(total_count: usize, page_size: usize, page_index: usize) -> usize {
    if total_count == 0 {
        0
    } else {
...
pub(super) fn pagination_page_end(total_count: usize, page_size: usize, page_index: usize) -> usize {
    (pagination_page_start(total_count, page_size, page_index) + page_size).min(total_count)
}

pub(super) fn related_work_page_summary(
    total_count: usize,
    page_size: usize,
    page_index: usize,
    label: &'static str,
...
#[cfg_attr(not(feature = "hydrate"), allow(dead_code))]
pub(super) fn visible_child_label(count: usize) -> String {
    match count {
...
pub(super) fn active_form_version(form: &FormSummary) -> Option<&FormVersionSummary> {
    form.versions
        .iter()
        .rev()
...
pub(super) fn active_form_definition_version(form: &FormDefinition) -> Option<&FormVersionSummary> {
    form.versions
        .iter()
        .rev()
        .find(|version| version.status == "published")
...
#[cfg_attr(not(feature = "hydrate"), allow(dead_code))]
pub(super) fn editable_form_definition_version(form: &FormDefinition) -> Option<&FormVersionSummary> {
    form.versions
        .iter()
        .rev()
...
pub(super) fn form_version_sort_label(version: &FormVersionSummary) -> String {
...
pub(super) fn workflow_assigned_users_label(workflow: &WorkflowSummary) -> String {
