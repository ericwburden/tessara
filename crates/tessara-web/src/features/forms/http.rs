//! Forms-local browser HTTP transport.
...
pub(in crate::features::forms) struct IdResponse {
    pub(in crate::features::forms) id: String,
}
...
#[cfg(feature = "hydrate")]
pub(in crate::features::forms) async fn send_json_id_request(
    builder: gloo_net::http::RequestBuilder,
    body: Option<String>,
    action: &str,
...
#[cfg(feature = "hydrate")]
pub(in crate::features::forms) fn redirect_to_login() {
