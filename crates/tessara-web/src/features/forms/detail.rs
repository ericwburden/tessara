//! Form detail content.
//!
//! Keep load-state switching here; read-focused detail presentation lives in `detail_content`.

use crate::features::forms::loaders::load_form_detail;
use crate::features::forms::{FormDefinition, FormDetailBody, RenderedForm};
use crate::ui::{
            ...
            {move || {
                if is_loading.get() {
                    ...
                    view! {
                        ...
                        <FormDetailBody form rendered_form=rendered_form.get()/>
                    }
                    .into_any()
                } else {
                    view! {
