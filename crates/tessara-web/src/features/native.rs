...
struct NodeTypeUpsertRequest {
    name: String,
    slug: String,
    plural_label: Option<String>,
    parent_node_type_ids: Vec<String>,
    child_node_type_ids: Vec<String>,
}

#[derive(Clone, Debug, Serialize)]
#[cfg_attr(not(feature = "hydrate"), allow(dead_code))]
struct CreateNodeMetadataFieldRequest {
    node_type_id: String,
    key: String,
    label: String,
    field_type: String,
...
#[derive(Clone, Debug, Serialize)]
#[cfg_attr(not(feature = "hydrate"), allow(dead_code))]
struct UpdateNodeMetadataFieldRequest {
    key: String,
    label: String,
    field_type: String,
    required: bool,
...
#[derive(Clone, Debug, Deserialize, PartialEq)]
struct AdminAccountAssignmentSummary {
    account_id: String,
    email: String,
    display_name: String,
}
...
#[derive(Clone, Debug, Deserialize, PartialEq)]
struct AdminRoleDetail {
    id: String,
    name: String,
    #[serde(default)]
    capabilities: Vec<AdminCapabilitySummary>,
    #[serde(default)]
    assigned_accounts: Vec<AdminAccountAssignmentSummary>,
}

#[derive(Clone, Debug, Serialize)]
#[cfg_attr(not(feature = "hydrate"), allow(dead_code))]
struct CreateAdminRolePayload {
    name: String,
