//! Organization node create/edit page implementations.
//!
//! Keep node editor page state and form composition here; organization route pages should stay focused on route-level explorer/detail composition.
