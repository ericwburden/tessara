//! Node-type administration route surface.

use super::actions::save_admin_node_type;
use super::state::AdministrationNodeTypesPageState;
use crate::features::administration::api::{
    load_admin_node_type_catalog, load_admin_node_type_detail,
};
use crate::features::administration::components::{
    AdministrationNodeTypeEditor, AdministrationNodeTypesList,
};
use crate::ui::{
...
#[component]
pub(super) fn AdministrationNodeTypesSurface() -> impl IntoView {
    let state = AdministrationNodeTypesPageState::new();
