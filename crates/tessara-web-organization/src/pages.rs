...
pub use super::node_editor::{OrganizationNodeCreateContent, OrganizationNodeEditContent};
use super::tree::{
...
pub fn OrganizationIndexContent() -> impl IntoView {
    ...
    view! {
        <section class="route-panel organization-page">
            ...
            <OrganizationDetailSheet detail is_loading=detail_is_loading error=detail_error/>
        </section>
    }
}
