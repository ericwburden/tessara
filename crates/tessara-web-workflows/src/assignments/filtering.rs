...
pub(crate) fn filtered_workflow_candidates(
...
pub(crate) fn filtered_node_candidates(
    candidates: Vec<WorkflowAssignmentCandidate>,
    query: &str,
...
pub(crate) fn workflow_assignment_pair_is_valid(
...
pub(crate) fn selected_workflow_summary(
    candidates: Vec<WorkflowAssignmentCandidate>,
    selected_id: &str,
...
pub(crate) fn selected_node_summary(
    candidates: Vec<WorkflowAssignmentCandidate>,
    selected_id: &str,
) -> Option<(String, String)> {
    candidates
...
pub(crate) fn filtered_assignees(
...
pub(crate) fn filtered_assignments(
...
pub(crate) fn assignee_filter_options(assignments: &[WorkflowAssignmentSummary]) -> Vec<String> {
