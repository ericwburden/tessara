...
pub(super) struct ComponentTableQueryInput<'a> {
    pub(super) search: &'a str,
    pub(super) page_size: &'a str,
    pub(super) cursor: &'a str,
    pub(super) sort_field: &'a str,
    pub(super) sort_direction: &'a str,
    pub(super) filter_field: &'a str,
    pub(super) filter_operator: &'a str,
    pub(super) filter_value: &'a str,
    pub(super) visible_columns: &'a str,
}

#[allow(dead_code)]
pub(super) fn build_component_table_query(input: ComponentTableQueryInput<'_>) -> String {
...
#[cfg_attr(not(test), allow(dead_code))]
pub(super) fn push_query_param(params: &mut Vec<String>, key: &str, value: &str) {
...
#[cfg_attr(not(test), allow(dead_code))]
pub(super) fn percent_encode_query_component(value: &str) -> String {
    value
        .bytes()
