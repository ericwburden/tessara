...
VALUES
    ...
    ('tessara.dashboards', 'tessara.core.dashboards',
     'tessara.dashboards.dashboard', 'dashboards.list', 'read',
     'dashboards:read'),
    ('tessara.dashboards', 'tessara.core.dashboards',
     'tessara.dashboards.dashboard', 'dashboards.list_manageable', 'read',
     'dashboards:manage'),
    ('tessara.dashboards', 'tessara.core.dashboards',
    ...
    ('tessara.dashboards', 'tessara.core.dashboards',
     ...
     'dashboards:manage'),
    ('tessara.dashboards', 'tessara.core.dashboards',
     'tessara.dashboards.dashboard', 'dashboards.update', 'mutation',
     'dashboards:manage'),
    ('tessara.dashboards', 'tessara.core.dashboards',
    ...
    ('tessara.dashboards', 'tessara.dashboards.component-version',
     ...
     'components:read'),
    ('tessara.dashboards', 'tessara.dashboards.component-version',
     'tessara.components.component-version', 'render', 'read',
     'components:read')
ON CONFLICT DO NOTHING;
