...
pub struct DraggablePanelListItem {
    pub id: String,
}

#[derive(Clone, Debug, Eq, PartialEq)]
pub enum DraggablePanelListAnchor {
    Start,
    After(String),
}

#[derive(Clone)]
pub struct DraggablePanelListDraggable {
    pub id: String,
    pub index: usize,
}

#[derive(Clone)]
pub struct DraggablePanelListDropZone {
    pub anchor: DraggablePanelListAnchor,
}

#[derive(Clone)]
pub struct DraggablePanelListMove {
    pub dragged_id: String,
    pub anchor: DraggablePanelListAnchor,
}

#[component]
pub fn DraggablePanelList(
