...
- Business scenario: A release operator activates Dashboard `2.0.2`, verifies
...
2. Candidate image `2.0.2` is available but not active.
...
| 2 | Start `2.0.2`, wait for health, and activate the candidate slot. | Normal Dashboard routes serve `2.0.2`; diagnostics, metadata, assets, and image labels agree. |  |  |  |
